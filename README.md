...
- Administration: Provide a way for a solicitor to view a list of uploaded documents and their current status.

## Podman:
This project uses podman so podman and podman-compose are required.
